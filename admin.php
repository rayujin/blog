...
require ('C:\wamp64\www\blog1\Includes\autoload.php');
...
if(!isset($_GET['page']))
{
	header("Location: http://localhost/blog1/admin.php?page=accueilAdmin");
	die();
}
else
{
...
<html>
	...
	<?php require ('C:\wamp64\www\Blog1\Includes\header.php') ?>
	...
	<?php require ('C:\wamp64\www\Blog1\Includes\footerAdmin.php') ?>
